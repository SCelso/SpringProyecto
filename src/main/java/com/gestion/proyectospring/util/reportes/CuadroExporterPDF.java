...
public class CuadroExporterPDF {

	private List<Cuadro> listaCuadros;

	public CuadroExporterPDF(List<Cuadro> listaCuadros) {
		super();
	...
	private void escribirDatosDeLaTabla(PdfPTable tabla) {
		for (Cuadro cuadro : listaCuadros) {
			tabla.addCell(String.valueOf(cuadro.getId()));
			tabla.addCell(cuadro.getNombre());
			tabla.addCell(cuadro.getAutor());
			tabla.addCell(cuadro.getFecha().toString());
		}
	}
	...
	public void exportar(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph titulo = new Paragraph("Lista de cuadros", fuente);
